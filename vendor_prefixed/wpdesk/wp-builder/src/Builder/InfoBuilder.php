 ...
 */
class InfoBuilder extends \ShopMagicCF7Vendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\ShopMagicCF7Vendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
