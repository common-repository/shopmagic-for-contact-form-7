...
trait HookableParent
{
    ...
    {
        if ($hookable_object instanceof \ShopMagicCF7Vendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant) {
    ...
    protected function hooks_on_hookable_objects()
    {
        ...
        foreach ($this->hookable_objects as $hookable_object) {
            if ($hookable_object instanceof \ShopMagicCF7Vendor\WPDesk\PluginBuilder\Plugin\Conditional) {
