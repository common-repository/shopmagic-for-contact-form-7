...
if (!\interface_exists('ShopMagicCF7Vendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('ShopMagicCF7Vendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('ShopMagicCF7Vendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \ShopMagicCF7Vendor\WPDesk_Translatable, \ShopMagicCF7Vendor\WPDesk_Buildable, \ShopMagicCF7Vendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
