...
namespace ShopMagicCF7Vendor\WPDesk\Notice;

use ShopMagicCF7Vendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use ShopMagicCF7Vendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \ShopMagicCF7Vendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $optionName = \ShopMagicCF7Vendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            ...
            \update_option($optionName, \ShopMagicCF7Vendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
