...
if (!\class_exists('ShopMagicCF7Vendor\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicCF7Vendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \ShopMagicCF7Vendor\WPDesk_Basic_Requirement_Checker
    {
        /**
