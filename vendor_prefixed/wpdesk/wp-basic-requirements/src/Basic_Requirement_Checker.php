...
if (!\interface_exists('ShopMagicCF7Vendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicCF7Vendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \ShopMagicCF7Vendor\WPDesk_Requirement_Checker
    {
